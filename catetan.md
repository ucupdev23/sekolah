...
1. pengumuman menjadi penting itu berdasarkan keyword dalam judul/isi, kewwordnya <penting, important, urgent, segera, darurat>

yang belum :

1. ✅ habis login diback masi kembali ke halaman login [done] 
2. ✅ halaman 404 dan 403 di custom tampilannya [done]
3. ✅ tahun kelulusan jadi crud aja, supaya filter bisa [done] <tapi bukan relasi>
...
- pengumuman, berita dan kelulusan
- tanpa kategori, tahun kelulusan dan admin user
